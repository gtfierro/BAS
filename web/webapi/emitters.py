...
# A patched version of piston.emitters
# see https://bitbucket.org/jespern/django-piston/issue/150/emitter-construction-should-check-for
...
emitters.XMLEmitter = XMLEmitter
emitters.JSONEmitter = JSONEmitter
emitters.YAMLEmitter = YAMLEmitter
emitters.PickleEmitter = PickleEmitter
emitters.DjangoEmitter = DjangoEmitter
